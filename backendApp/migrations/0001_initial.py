# Generated by Django 5.0.6 on 2024-10-05 16:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('timeSlot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backendApp.mealordertimeslot')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.AddField(
            model_name='vehicle',
            name='vehicle_status',
            field=models.ForeignKey(db_column='vehicle_status_code', on_delete=django.db.models.deletion.CASCADE, to='backendApp.vehiclestatus'),
        ),
    ]

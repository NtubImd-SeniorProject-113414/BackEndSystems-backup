# Generated by Django 4.2.6 on 2024-10-18 23:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DeliveryStatus',
            fields=[
                ('delivery_status_code', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='OrderState',
            fields=[
                ('order_state_code', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient_image_path', models.ImageField(blank=True, max_length=255, null=True, upload_to='patients/')),
                ('created_time', models.DateTimeField(default=django.utils.timezone.now)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qr_code_image', models.CharField(max_length=100)),
                ('action_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backendApp.actiontype')),
            ],
        ),
        migrations.CreateModel(
            name='Sides',
        ...
        migrations.CreateModel(
            name='VehicleStatus',
            fields=[
                ('vehicle_status_code', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('vehicle_status', models.ForeignKey(db_column='vehicle_status_code', on_delete=django.db.models.deletion.CASCADE, to='backendApp.vehiclestatus')),
            ],
        ),
        migrations.CreateModel(
            name='TurnPoint',
            fields=[
                ...
                ('qr_point', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backendApp.qrcodepoint')),
            ],
        ),
        migrations.CreateModel(
            name='RouteCondition',
            fields=[
                ('route_condition_id', models.AutoField(primary_key=True, serialize=False)),
                ('patient', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backendApp.patient')),
                ('turn_point', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backendApp.turnpoint')),
            ],
        ),
        migrations.CreateModel(
            name='RfidCard',
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('patient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backendApp.patient')),
            ],
        ),
        migrations.CreateModel(
            name='PurchaseDetail',
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('purchase', models.ForeignKey(db_column='purchase_id', on_delete=django.db.models.deletion.CASCADE, to='backendApp.purchase')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='backendApp.qrcodepoint'),
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('course', models.ForeignKey(db_column='course_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='backendApp.maincourse')),
                ('order_state', models.ForeignKey(db_column='order_state_code', on_delete=django.db.models.deletion.CASCADE, to='backendApp.orderstate')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backendApp.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('medicineDemandState', models.ForeignKey(db_column='medicineDemandState_code', on_delete=django.db.models.deletion.CASCADE, to='backendApp.medicinedemandstate')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backendApp.patient')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='backendApp.qrcodepoint')),
                ('delivery_status', models.ForeignKey(db_column='delivery_status_code', on_delete=django.db.models.deletion.CASCADE, to='backendApp.deliverystatus')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_assignments', to='backendApp.order')),
                ('vehicle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_assignments', to='backendApp.vehicle')),
            ],
        ),
        migrations.CreateModel(
            name='CourseSides',
